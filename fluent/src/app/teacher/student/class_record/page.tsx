...
`;
  ...
  <ol>
    <li>가능하면 헬스장에 갈 수도 있어.</li>
    <li>이 영화는 해리 포터와 비슷해.</li>
    <li>그게 우리가 지난번에 본 거 아니야?</li>
    <li>그 영화는 우리가 지난주에 본 거야.</li>
    <li>오랜만에 옛 친구와 안부를 나눴어. (근황토크)</li>
    <li>한국에서 가장 유명한 레스토랑 중 하나에서 식사했어.</li>
    <li>날씨에 따라 달라.</li>
    <li>나는 모든 종류의 음악을 좋아하지만, 특히 재즈를 사랑해.</li>
    <li>어떻게든 프로젝트를 끝냈어.</li>
    <li>프로젝트가 어려웠지만, 그래도 끝냈어.</li>
    <li>원래는 해외여행을 계획했지만, 대신 집에 있기로 결정했어.</li>
    <li>보통 나는 매일 아침 7시에 일어나.</li>
    <li>결론적으로 2가지</li>
    <li>결국에는 2가지</li>
    <li>드디어 2가지</li>
    <li>결과로서</li>
    <li>내가 파티에 가지 않은 이유는 일 때문에 너무 지쳤기 때문이야.</li>
    <li>내가 고향을 마지막으로 방문한 것은 아주 오래 전이야.</li>
    <li>버스를 놓쳤어. 그래서 늦었어.</li>
    <li>등산은 힘들었지만, 그만한 가치가 있었어.</li>
    <li>개인적으로, 나는 이것이 최선의 선택이라고 생각해.</li>
    <li>건강에 좋지 않다는 걸 알지만, 어쩔 수 없어.</li>
    <li>150만원은 달러로 얼마야?</li>
    <li>그는 나에게 30만원을 빚졌어.</li>
    <li>대화가 이상해졌어.</li>
    <li>카페에서 전 애인을 만났을 때 어색했어.</li>
    <li>이 프로젝트를 통해 그녀를 잘 알게 됐어. (close 아님)</li>
    <li>우리는 아직 서로를 알아가는 중이야.</li>
    <li>그 영화를 보는 것은 시간 낭비였어.</li>
    <li>그 비싼 가방을 사는 것은 돈 낭비였어.</li>
    <li>내가 너라면, 매니저와 얘기할 거야.</li>
    <li>이것 좀 도와줄 수 있을까?</li>
    <li>결국 그 행사에 자원봉사를 하게 됐어.</li>
    <li>왠지 그 노래에 대해 계속 생각이 났어.</li>
    <li>그녀는 내내 조용했어.</li>
    <li>그런데, 장소가 어디였지?</li>
    <li>어쩔 수 없어.</li>
    <li>어제 소개팅을 가기로 했는데 취소됐어.</li>
    <li>그렇게 했어야 했는데.</li>
    <li>내가 너라면 그렇게 했을 거야.</li>
    <li>결국 시험에 늦었어.</li>
    <li>중간고사를 거의 다 끝냈어.</li>
    <li>우리 아이들이 잘 어울려서 기뻐.</li>
    <li>내가 너라면, 나도 긴장됐을 거야.</li>
    <li>왠지 잠을 잘 수 없었어.</li>
    <li>대략 5만원 정도 들었어.</li>
    <li>빨리 끝내자.</li>
    <li>그만한 가치가 있었어! / 그만한 가치가 없었어.</li>
    <li>네가 자고 있을 거라고 생각했어.</li>
    <li>다이어트 중이라서 체중을 줄이려고 노력 중이야.</li>
    <li>지난 2주 동안 체중이 많이 늘었어.</li>
    <li>넷플릭스 시리즈의 이 밈이 소셜 미디어에서 바이럴했어.</li>
    <li>난 그걸 믿지 않아!</li>
    <li>일반적으로, 달리기에서 여자들은 남자들을 따라가지 못해.</li>
    <li>행사에 더 일찍 왔어야 했는데! 하지만 교통이 혼잡했어.</li>
    <li>낙관적인 / 비관적인</li>
    <li>응원할게! / 널 응원해!</li>
    <li>얼마나 오래 밖에 있었어?</li>
    <li>우리는 서로 그다지 잘 맞지 않아.</li>
    <li>우리 사이에 잘 안 될 것 같아.</li>
    <li>그게 정말 필요해?</li>
    <li>오늘 당직이야 (야간 근무)</li>
    <li>어제 우리가 산 것보다 두 배나 비싸 (두 배의 가격)</li>
    <li>그냥 안 가면 안 돼?</li>
    <li>어떻게 될지 두고 보자!</li>
    <li>가야 한다는 압박감을 느꼈어 / 나한테 압박 주지 마!</li>
    <li>아무도 그 이유를 몰라.</li>
    <li>그가 떠났다는 것도 몰랐어.</li>
    <li>왜 그런 거야?</li>
    <li>그게 무슨 상관이야?</li>
    <li>너에게 부담을 주고 싶지 않아.</li>
    <li>그가 안타까웠어.</li>
    <li>너의 의견으로는 어떤 게 제일 좋아?</li>
    <li>그 돈을 너한테 쓰는 게 낫겠어.</li>
    <li>술 마시러 가는 것보다 운동하러 가는 게 낫겠어.</li>
    <li>당황한 / 당황스러운</li>
    <li>좀 주제에서 벗어나지만...</li>
    <li>10명 중 9명은 그렇게 할 거야.</li>
    <li>다시 생각해보니, 그 가방을 사지 말았어야 했어.</li>
    <li>나는 "프렌즈" TV 쇼에 완전히 빠졌어.</li>
    <li>말 끊어서 미안해.</li>
    <li>약 먹는 걸 잊었어.</li>
    <li>사업은 어떻게 돼가?</li>
    <li>부럽다 / 네가 부러워.</li>
    <li>내가 말했는지 모르겠네.</li>
    <li>너와는 관련이 없어 / 너와는 아무 상관이 없어.</li>
    <li>지난 2개월 동안</li>
    <li>분위기를 읽어 / 조심스럽게 행동해</li>
    <li>짧은 방문인데도 항상 내가 음식값을 내야 해.</li>
    <li>나 얘기는 그만하고, 너희 얘기 좀 해봐.</li>
    <li>모니터 암이 뭔지 알아?</li>
    <li>정신적 붕괴가 왔어.</li>
    <li>나 자신에게 매우 실망했어.</li>
    <li>네가 나를 사랑하는 한</li>
    <li>네가 일만 하면 돼.</li>
    <li>내가 아는 바로는</li>
    <li>걱정 마, 내가 먼저 연락할게.</li>
  </ol>

  <h3>Answer Key - Intermediate Pillar Expressions</h3>
  <ol>
    <li>I might go to the gym later if I can.</li>
    <li>This movie is similar to Harry potter</li>
    <li>isn't that what we watched last time?</li>
    <li>The movie is one that we watched last week.</li>
    <li>I caught up with an old friend for the first time in a while.</li>
    <li>I dined at one of the most famous restaurants in Korea.</li>
    <li>It depends on the weather.</li>
    <li>I like all kinds of music, but I specifically love jazz.</li>
    <li>I finished the project somehow</li>
    <li>even though the project was difficult, I finished it (even if)</li>
    <li>Originally, I planned to travel abroad, but I decided to stay home instead.</li>
    <li>Normally, I wake up at 7 AM every day.</li>
    <li>All in all / In conclusion</li>
    <li>eventually / In the end</li>
    <li>finally / at last</li>
    <li>As a result</li>
    <li>The reason that I didn't go to the party was because I was too drained from work.</li>
    <li>The last time that I visited my hometown was ages ago.</li>
    <li>I missed the bus. That's why I was late.</li>
    <li>The hike was tough, but it was worth it.</li>
    <li>Personally, I think this is the best option.</li>
    <li>I know it's unhealthy, but I can't help it.</li>
    <li>How much is 1,500,000 won in dollars?</li>
    <li>He owes me 300,000 won.</li>
    <li>The conversation got weird.</li>
    <li>It felt awkward when I met my ex at the café.</li>
    <li>I got to know her well through this project.</li>
    <li>we're still getting to know each other</li>
    <li>Watching that movie was a waste of time.</li>
    <li>Buying that expensive bag was a waste of money.</li>
    <li>If I were you, I would talk to the manager.</li>
    <li>Would you mind helping me with this?</li>
    <li>I ended up volunteering for the event.</li>
    <li>For some reason, I couldn't stop thinking about that song.</li>
    <li>She was quiet for the whole time.</li>
    <li>By the way, where is the venue again?</li>
    <li>I can't help it</li>
    <li>I was supposed to go on a blind date yesterday but it got canceled</li>
    <li>I should've {~했었어야 했다}</li>
    <li>I would've {나라면 ~를 했을 것이다}</li>
    <li>I ended up being late to the test</li>
    <li>I'm pretty much done with my midterms</li>
    <li>I'm glad that our kids got along</li>
    <li>if I were you, I would be nervous too</li>
    <li>I couldn't sleep for some reason</li>
    <li>it cost roughly 50,000won</li>
    <li>let's get it over with</li>
    <li>it was worth it! / it wasn't worth it</li>
    <li>I figured that you were sleeping</li>
    <li>I'm trying to lose weight because I'm on a diet.</li>
    <li>I gained a lot of weight over the last 2 weeks.</li>
    <li>this meme from a netflix series went viral on social media. (it blew up)</li>
    <li>I don't buy it!</li>
    <li>generally, girls can't keep up with guys when running</li>
    <li>I should've come to the event earlier! but the traffic was heavy.</li>
    <li>optimistic / pessimistic</li>
    <li>I'm cheering for you! / I'm rooting for you!</li>
    <li>how long did you stay out?</li>
    <li>we're not that compatible with each other</li>
    <li>it's not gonna work out between us</li>
    <li>is that even necessary?</li>
    <li>I'm on duty today (the night shift)</li>
    <li>it's twice as expensive as the one we bought yesterday (twice the price)</li>
    <li>why can't we just not go?</li>
    <li>we'll see how it goes!</li>
    <li>I felt pressured to go / stop pressuring me!</li>
    <li>no one knows why</li>
    <li>I didn't even know that he left</li>
    <li>why is that the case?</li>
    <li>what does that have to do with anything?</li>
    <li>I don't want to burden you</li>
    <li>I felt bad for him</li>
    <li>In your opinion, which one is the best?</li>
    <li>I would rather spend that money on you</li>
    <li>I would rather go work out than go drink</li>
    <li>embarrassed / embarrassing</li>
    <li>this is kind of a tangent but ..</li>
    <li>9 out of 10 people would do that</li>
    <li>on second thought, I should've never bought that bag</li>
    <li>I'm totally obsessed with the TV show "friends"</li>
    <li>sorry to cut you off</li>
    <li>I forgot to take my medicine</li>
    <li>how is your business going?</li>
    <li>I'm jealous / I envy you</li>
    <li>I'm not sure if I told you</li>
    <li>it's not related with / it doesn't have anything to do with you</li>
    <li>for the last 2 months</li>
    <li>read the room / walk on eggshells</li>
    <li>I always have to pay for food even though it's a short visit.</li>
    <li>enough about me, tell me about you guys</li>
    <li>do you know what a monitor arm is?</li>
    <li>I had a mental breakdown</li>
    <li>I was very disappointed in myself</li>
    <li>as long as you love me</li>
    <li>as long as you do your work, it's all good</li>
    <li>from what I know</li>
    <li>don't worry, I'll reach out first</li>
    <li>what's the worst case scenario?</li>
  </ol>

  <h2>Pillar Vocab (ask 10)</h2>
  ...
  <ol>
    ...
    <li>자극하다</li>
    <li>유능한 직원</li>
    <li>시간을 잘 지키는 / 시간 엄수하는</li>
    <li>정치</li>
    <li>욕설 / 욕하기</li>
    <li>총각 파티 / 신부 파티 (결혼 전 파티)</li>
    <li>스트리퍼들 (춤추는 사람들)</li>
    <li>장소 / 개최지</li>
    <li>의무적인 / 필수의</li>
    <li>무언가가 유행하고 있다</li>
    ...
    <li>다과 / 음료수들</li>
    <li>야망 있는 / 포부가 큰</li>
    <li>느긋한 / 여유로운 (혹은 "진정해"라는 표현으로도 사용)</li>
    <li>기진맥진한 / 매우 지친</li>
    <li>꽃뱀들 (돈만 노리는 사람들)</li>
    <li>일생에 한 번뿐인 기회</li>
    <li>귀걸이 / 목걸이 / 팔찌들</li>
    <li>치아 교정기 (브레이스)</li>
    <li>치실 (플로스)</li>
    ...
    <li>장례식</li>
    <li>공통 친구들</li>
    <li>~을 이용하다 (부정적 뉘앙스 포함 가능)</li>
    <li>병가를 내다 (아프다고 연락하다)</li>
    <li>집착하는 / 푹 빠진</li>
    <li>첫째로 / 둘째로</li>
    <li>직설적인 / 솔직한</li>
  </ol>
  ...
  <ol>
    ...
    <li>picky</li>
    <li>invest in stocks and bonds</li>
    <li>consider</li>
    <li>refer to</li>
    <li>regarding ~</li>
    <li>skeptical</li>
    ...
    <li>stimulate</li>
    <li>a competent employee</li>
    <li>punctual</li>
    <li>politics</li>
    <li>swearing / cussing / cursing</li>
    <li>bachelor party / bridal shower</li>
    <li>strippers</li>
    <li>venue</li>
    <li>mandatory</li>
    <li>something is trending</li>
    <li>i'm hesitating</li>
    <li>convenient</li>
    <li>straightforward / direct</li>
    <li>accommodation</li>
    ...
    <li>exhausted</li>
    <li>gold diggers</li>
    <li>once in a lifetime opportunity</li>
    <li>earrings / necklaces / bracelets</li>
    <li>braces</li>
    <li>floss</li>
    <li>sensitive and caring</li>
    <li>respectful</li>
    <li>cringy</li>
    <li>prove / approval</li>
    <li>vote for the election</li>
    <li>funeral</li>
    <li>mutual friends</li>
    <li>take advantage of</li>
    <li>call in sick</li>
    <li>obsessed</li>
    <li>first of all / second of all</li>
    <li>straightforward</li>
  </ol>

  <h3>End Timer: 45 minute mark (15 minutes left for feedback)</h3>

  <h2>New expressions to add</h2>
  <ol>
    <li>my girlfriend asked me not to drive</li>
    <li>interestingly enough,</li>
    <li>we booked a pension that is run by a chef</li>
    <li>"the more I eat it, the more I like it"</li>
    <li>As I get older / the older I get</li>
    <li>As time goes by</li>
    <li>I'm having second thoughts</li>
    <li>I have FOMO (fear of missing out)</li>
    <li>we made this from scratch</li>
    <li>he's such a gentleman</li>
    <li>she's a perfectionist</li>
  </ol>
